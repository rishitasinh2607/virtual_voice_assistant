...
#time.sleep(2)
#respond('hello tina,what can i do for you?')
#listening = True
#while listening == True:
    ...
    if "email" in data:
        ...
        to = listen()
        edict = {'hello':'rishitasingh2607@gmail.com','just':'rithika199626@gmail.com'}
        toaddr = edict[to]
        ...
        #login
        mail.login('rithika199626@gmail.com','7285926297')

        mail.sendmail('rithika199626@gmail.com',toaddr,content)
...
time.sleep(2)
respond("Hello rishita,what can I do for you?")
listening = True
while listening == True:
    data = listen()#call the listen() here
    listening = voice_assistant(data)
